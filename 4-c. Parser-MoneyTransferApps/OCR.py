...
def detect_properties(path):
    credential_path = "<your project directory>/<json file with API keys>.json"
...
folder_images_path = "<your project dirctory>/MoneyTransferApps/Photos"
...
parent_dir = "<your project dirctory>/Money-Transfer-Apps-Parser"
