...
if __name__ == '__main__':
    ...
    folder_textdoc_path = '<your project dirctory>/MoneyTransferApps/Textfiles'
    ...
    with open('MoneyTransferApps'+'.csv','w', newline='', encoding='utf-8') as f1:
        ...
        for text_doc in textdoc_paths:
            try:
                ...
                del_file = '<your project dirctory>/MoneyTransferApps/Textfiles/' + file_name
                os.remove(del_file)
                picture_file = file_name[0:-3] + "jpg"
                the_picture_file = "<your project dirctory>/MoneyTransferApps/Photos/" + picture_file
